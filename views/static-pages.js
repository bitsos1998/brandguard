...
const PAGES = {
  'how-it-works': {
    ...
    body: `
      <h2>1. Ζητάτε δωρεάν έλεγχο</h2>
      <p>Συμπληρώνετε μια σύντομη φόρμα με το όνομα της επιχείρησής σας, τον κλάδο και την πόλη. Δεν χρειάζεται πιστωτική κάρτα, δεν σας εγγράφουμε σε newsletter, δεν μοιραζόμαστε τα στοιχεία σας με κανέναν.</p>
      ...
      <p>Αν βρούμε ότι είστε καθαροί, μπορείτε να προχωρήσετε σε κατοχύρωση με το <strong>Filing Kit (€79)</strong> ή να βάλετε το brand σας σε <strong>Monitoring (€99/έτος)</strong> για συνεχή παρακολούθηση. Αν υπάρχει σύγκρουση, η αναφορά μας σας λέει ακριβώς με ποιον πρέπει να μιλήσετε και γιατί.</p>
  ...
  pricing: {
    ...
    description: 'Τιμοκατάλογος υπηρεσιών BrandGuard: δωρεάν αρχικός έλεγχος, Filing Kit €79, Monitoring €99/έτος.',
    label: 'Τιμοκατάλογος',
    h1: 'Τιμές',
    lead: 'Ο αρχικός έλεγχος είναι πάντα δωρεάν. Πληρώνετε μόνο αν επιλέξετε κατοχύρωση ή συνεχή παρακολούθηση.',
    body: `
      <h2>Δωρεάν Έλεγχος — €0</h2>
      ...
      <h2>Filing Kit — €79 (best value)</h2>
      ...
      <div class="callout">
        <strong>Bundle deal:</strong> Filing Kit + Monitoring για 1 έτος = €149 (εξοικονομείτε €29). Επικοινωνήστε στο hello@brandguard.gr.
      </div>
    `,
  },
  ...
  faq: {
    ...
    body: `
      ...
      <p>Τέλη ΟΒΙ για μία κλάση: περίπου €110. Επιπλέον κλάσεις: ~€20 καθεμία. Με το Filing Kit μας (€79) το σύνολο για ένα πλήρως κατοχυρωμένο σήμα ξεκινάει από ~€189.</p>
  ...
  privacy: {
    ...
    body: `
      ...
      <ul>
        <li>Για να απαντήσουμε στο αίτημά σας για δωρεάν έλεγχο.</li>
  ...
  partner: {
    ...
    description: 'Κερδίστε €15 για κάθε πελάτη που παραπέμπετε στο BrandGuard. Ιδανικό για λογιστές, συμβούλους, web designers.',
    label: 'Partnership',
    h1: 'Κερδίστε €15 για κάθε πελάτη που παραπέμπετε',
    ...
    body: `
      ...
      <ol>
        ...
        <li><strong>Πληρώνεστε κάθε μήνα.</strong> Για κάθε Filing Kit (€79) που αγόρασε κάποιος με τον κωδικό σας, κερδίζετε <strong>€15</strong>. Για κάθε Monitoring subscription (€99/έτος) που ανανεώνεται, κερδίζετε <strong>€20/έτος</strong>.</li>
      </ol>

      <h2>Γιατί αξίζει</h2>
      <p>Ο μέσος όρος για λογιστή στην Αθήνα είναι ~80 ενεργοί πελάτες-επιχειρήσεις. Αν το 20% αγοράσει Filing Kit το πρώτο έτος, αυτό είναι 16 conversions × €15 = <strong>€240 καθαρό εισόδημα τον χρόνο από κάτι που ήδη συζητάτε</strong>.</p>
      ...
      <ul>
        <li>Δωρεάν αρχικό έλεγχο (όπως όλοι).</li>
